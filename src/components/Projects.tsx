...
const Projects = () => {
    ...
    return (
        <div id="portfolio" className="h-auto lg:mx-20 md:mx-16 mx-8">
            <div data-aos="fade-up">
            <div className="lg:text-5xl md:text-[2.5rem] text-4xl font-medium text-gradient2 lg:ml-32 md:ml-2 ml-0 lg:w-[27%] md:w-[39%] w-[68%]">PORTFOLIO</div>
            <div className="border-l border-gray-600 lg:w-[65%] md:w-[100%] w-[95%] lg:ml-52 md:ml-16 ml-4 mt-2 mb-8 font-aldrich lg:text-lg md:text-lg text-sm font-semibold text-violet-300 lg:px-10 md:px-6 px-3 lg:py-7 md:py-4 py-4">
                {
                    projects.map((project) => (
                        <div key={project.id} className="flex flex-col md:flex-row lg:flex-row items-center lg:gap-20 md:gap-10 gap-5 my-1 lg:w-[60vw] md:w-[75vw] w-[80vw] lg:p-5 md:p-3.5 p-2" data-aos="fade-right">
                            ...
                            <div className="lg:w-[50%] md:w-[50%] w-[100%] lg:mx-0 md:mx-0 mx-[10%] mt-3">
                                <Link to={project.project_link}>
                                    <img className="lg:w-[30rem] md:w-[25rem] w-[18rem] rounded-xl hover:scale-105 transition" src={project.project_img} />
                                </Link>
                            </div>
                        </div>
                    ))
